...
public class CarpetPlusPlusSettings {
    ...
    @Rule(
            desc = "A chain of falling anvils will make any block that is unobtainable in survival that it hits fall",
            extra = "A full anvil must hit a chipped one, which must hit a damaged one, which must hit the block",
