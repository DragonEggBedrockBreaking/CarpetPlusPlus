...
public class CarpetPlusPlusSettings {
    ...
    public static final boolean renewableCalcite = false;
    ...
    public static final boolean renewableTuff = false;
    ...
    public static final boolean husksShedSand = false;
    ...
    public static final boolean husksDropRedSand = false;
    ...
    public static final boolean dispensersMakeOres = false;

    @Rule(
            desc = "Cave spiders walking through string weave cobwebs",
            category = {CPP, FEATURE, SURVIVAL}
    )
    public static final boolean cobwebWeaving = false;

    @Rule(
            desc = "Iron golems standing on big dripleaves 'crushes' them down to small dripleaves",
            category = {CPP, FEATURE, SURVIVAL}
    )
    public static final boolean dripleafCrushing = false;
    ...
    public static final boolean brutesDropBannerPatterns = false;
    ...
    public static final boolean brutesDropPigstepDiscs = false;
